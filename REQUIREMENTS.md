...
Evidence names the automated tests that check each row. All 331 tests pass with `python3 -m unittest` (25 Sep 2026), and the model unit tests cover 100 % of the countable lines in `model/` (`coverage.txt`).
